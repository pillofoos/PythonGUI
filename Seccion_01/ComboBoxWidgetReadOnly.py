#Objetivo: muestra como agregar un ComboBox widget, ponerlo readonly para que no se pueden modificar los valores
#          y recuperar el valor seleccionado
...
def clickMe():
    aButton.configure(text="Hola "+nombre.get()+' '+numero.get())
...
numero = tk.StringVar()
numeroComboBox = ttk.Combobox(ventana, width=20, textvariable=numero, state='readonly')
